...
assets.precompile += %w(application.js jquery.js jquery_ujs.js admin.js reports.js norms.js styles.js edit_company.js common.js global_configurations/fallback_strategy.js shared/leadsquared.js add_candidates.js add_traits.js pie.min.js plotPie.js)
assets.precompile += %w(highcharts-custom.js trr-pie.js)
