...
assets.precompile += %w(application.js jquery.js jquery_ujs.js admin.js reports.js norms.js styles.js edit_company.js common.js)
...
assets.precompile += %w(lead_squared.js)
