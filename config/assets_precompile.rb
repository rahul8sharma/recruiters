...
assets.precompile += %w(reports_html.css reports_pdf.css group_report.css oac_report_html.css mrf_report_pdf.css)
...
assets.precompile += %w(oac/set_weightage_oac.js oac/add_users.js)
