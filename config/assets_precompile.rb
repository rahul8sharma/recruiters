...
assets.precompile += %w(highcharts-custom.js trr-pie.js template.js report_configurations.js jstree.css)
assets.precompile += %w(competencies_management.js show_report_configurations.js)
assets.precompile += %w(shared.css)
assets.precompile += %w(reports_html.css reports_pdf.css mrf_report_pdf.css oac_report_html.css)
...
assets.precompile += %w(mrf/add_stakeholders.js mrf/add_users.js set_report_configration.js)
assets.precompile += %w(walkins/email_settings.js)
assets.precompile += %w(jquery-ui/jquery.comiseo.daterangepicker.css)
assets.precompile += %w(suitability/reports.js jquery-ui/jquery.comiseo.daterangepicker.min)
assets.precompile += %w(jquery-ui/jquery-ui.css)
assets.precompile += %w(mrf/walkins/email_settings.js)
assets.precompile += %w(oac/set_weightage_oac.js)
