...
assets.precompile += %w(select_company.js feedback_report/html.css)
assets.precompile += %w(suitability/html/fit.css suitability/html/competency.css)
assets.precompile += %w(suitability/html/super_competency.css suitability/html/sjt_super_competency.css)
assets.precompile += %w(suitability/pdf/fit.css suitability/pdf/competency.css)
assets.precompile += %w(suitability/pdf/super_competency.css suitability/pdf/sjt_super_competency.css)
