class Suitability::FactorNormBucketDescriptionsController < ApplicationController
  ...
  def import_via_s3
    ...
    s3_key = 'suitability_factor_norm_bucket_descriptions.csv.zip'
  ...
  def export_to_google_drive
    ...
    redirect_to manage_suitability_factor_norm_bucket_descriptions_path, notice: "Export operation queued. Email notification should arrive as soon as the export is complete."
  end

  # GET /factors
  def index
    params[:search] ||= {}
    @factor_norm_bucket_descriptions = Vger::Resources::Suitability::FactorNormBucketDescription.where(
