class AssessmentsController < ApplicationController
  ...
  def show
    @assessment_factor_norms = @assessment.job_assessment_factor_norms.where(:include  => [:from_norm_bucket, :to_norm_bucket], :include => { :factor => { :methods => [:type, :direct_predictor_ids] } }).all.to_a
