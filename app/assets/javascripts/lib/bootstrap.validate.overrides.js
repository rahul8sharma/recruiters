// Overrides for jQuery validate to play nice with Bootstrap.
...
$.extend($.validator.messages, {
  ...
  maxlength: jQuery.validator.format('needs to be less than {0} characters'),
